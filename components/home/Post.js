...
const PostHeader = ({post}) => (
   ...
   const PostImage = ({post}) => (
    ...
    <Image 
        ...
        style={{ height: "100%", resizeMode: "cover", position: 'none'}} 
    />
    </View>
   )
   ...
   const postFooterIcons = [
    ...
    {
        name: 'Share',
        imageUrl:'https://img.icons8.com/fluency-systems-regular/60/ffffff/ios/sent',
    },
    {
        name: 'Save',
...
const PostFooter = ({handleLike, post}) => (
  <View style={{flexDirection: "row"}}>
    ...
    <View style={styles.leftFooterIconsContainer} >
        ...
        <Icon imgStyle={[styles.footerIcon, {transform : [{ rotate: '320deg' }]}]} imgUrl={postFooterIcons[2].imageUrl} />
    </View>
